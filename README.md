...
* Visit the official sites at [pwnsat.org](https://pwnsat.org).
* Please review the contribution manuals and Community Code of Conduct before submitting Pull Requests.

---

## License

Hardware designs are released under the CERN Open Hardware Licence v1.2. Please support open-source hardware by purchasing official products directly from Electronic Cats.
